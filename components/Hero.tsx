...
export function Hero() {
  return (
    <section className="relative flex flex-1 flex-col justify-center overflow-x-hidden py-8 md:py-10">
      ...
      <div className="container relative z-[1] flex flex-col items-start gap-12 md:flex-row md:items-center">
        <div className="max-w-xl space-y-6">
          <span className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium text-white/80 backdrop-blur">
            Tera · Custom software for U.S. businesses
          </span>
          ...
          <div className="mx-auto w-full max-w-sm md:hidden">
            <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-4 shadow-2xl shadow-black/40 backdrop-blur">
              <div className="mb-3 flex items-center gap-2">
                ...
                <span className="ml-2 text-xs text-white/60">app.yourbusiness.com</span>
              </div>
              <div className="rounded-xl bg-navy/70 p-4">
                ...
                <div className="mb-6 space-y-2">
                  ...
                  <div className="h-3 w-[66%] rounded-full bg-white/5" />
                </div>
          ...
          <p className="text-balance text-sm text-white/70 md:text-base">
            We design and build websites, apps, and internal tools around your workflow. Fast to
            ship, easy for staff to pick up, and built so you can grow into the next version.
          </p>
          ...
          <p className="text-xs text-white/50">
            Most well-scoped builds go from kickoff to launch in weeks, not quarters. You always see
            what ships next before we build it.
          </p>
        </div>
        ...
        <div className="relative hidden w-full max-w-md md:block md:max-w-lg">
          ...
          <div className="absolute -bottom-8 -right-6 hidden w-52 rounded-2xl border border-white/10 bg-navy/90 p-3 text-xs text-white/80 shadow-lg shadow-black/40 md:block">
            <p className="min-h-[1.25em] font-semibold">
              <TypewriterText words={BUSINESS_TYPES} />
            </p>
            <p className="text-[11px] text-tera-green">Shipped in under 3 weeks</p>
            <p className="mt-1 text-[11px] text-white/60">
              Recent build: daily field reports plus an admin dashboard.
            </p>
          </div>
        </div>
      </div>
